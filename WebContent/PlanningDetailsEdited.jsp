...
<title>Updated Smart Working planning</title>
</head>
<body>
...
<div id="global">
    <h3 align="center">Planning for user <%=session.getAttribute("name")%> has been updated correctly. Please find here below the details</h3>
    <p>
		<table width="700" border="1" cellpadding="2" cellspacing="2">
  		<thead>
    		...
    		<tr>
    			<td>
    				<c:if test="${not empty editPlanning.mondayFirstWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>
				
    			<td>
    				<c:if test="${not empty editPlanning.tuesdayFirstWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>
    			
    			<td>
    				<c:if test="${not empty editPlanning.wednesdayFirstWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>

    			<td>
    				<c:if test="${not empty editPlanning.thursdayFirstWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>				

    			<td>
    				<c:if test="${not empty editPlanning.fridayFirstWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>					
  		...
  		<thead>
    		...
    		<tr>
    			<td>
    				<c:if test="${not empty editPlanning.mondaySecondWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>
				
    			<td>
    				<c:if test="${not empty editPlanning.tuesdaySecondWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>
    			
    			<td>
    				<c:if test="${not empty editPlanning.wednesdaySecondWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>

    			<td>
    				<c:if test="${not empty editPlanning.thursdaySecondWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>				

    			<td>
    				<c:if test="${not empty editPlanning.fridaySecondWeek}">
    				<h2 style="color:orange;">Requested</h2> <br/>
    				</c:if>
    			</td>					
